...
class NdlFloor : public ObjectBase
{
public:
	...
	// コンストラクタ
	NdlFloor(const ObjectBase::ObjectData& data);

	// デストラクタ
	~NdlFloor(void) override;
